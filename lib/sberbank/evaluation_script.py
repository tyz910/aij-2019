...
class Evaluation(object):
    ...
    def __init__(self):
        ...
        self.test_path = sber_path('/var/sberbank/public_set/test')
        self.score_path = sber_path('/var/sberbank/evaluation/scoring.json')
    ...
    def solver_fitting(self):
        ...
        for i, solver in enumerate(self.solvers):
            ...
            if hasattr(solver, "load"):
                ...
                solver.load(sber_path('/var/sberbank/models/solver{}.pkl').format(solver_index))
            else:
